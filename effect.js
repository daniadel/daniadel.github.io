...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#b10,#b11a').stop();
			...
			$('#b110').animate({top:240, left: vw+350},500);
	...
	function loop11() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#b11a').animate({left:randleft,bottom:randtop},10000,function(){
			loop11();
		});
	}
	...
	$('#balloons_flying').click(function(){
		...
		$('#b1,#b4,#b5,#b7,#b9,#b11a').addClass('balloons-rotate-behaviour-one');
